...
protected:
	...
	BinaryNode<ItemType>* removeValue(BinaryNode<ItemType>* subTreePtr, const ItemType
		target, bool& success);
	...
	BinaryNode<ItemType>* removeLeftmostNode(BinaryNode<ItemType>* nodePtr, const ItemType& inorderSuccessor);

	// Recursively searches for target value in the tree by using a
	// preorder traversal.
	BinaryNode<ItemType>* find(BinaryNode<ItemType>* aTree, const ItemType& findItem,
		bool& success) const;
...
public:
	...
	BinaryNodeTree(const ItemType& rootItem, const BinaryNodeTree<ItemType>
		* leftTreePtr, const BinaryNodeTree<ItemType>* rightTreePtr);
	...
	//------------------------------------------------------------------------
	void attachLeft(const ItemType& anEntry) const throw(PrecondViolatedExcep);
	void attachRight(const ItemType& anEntry) const throw(PrecondViolatedExcep);
	...
	void attachRightSubtree(BinaryNodeTree<ItemType>* rightTreePtr) const
		throw(PrecondViolatedExcep);
	BinaryNodeTree<ItemType> detachLeftSubtree() const throw(PrecondViolatedExcep);
	BinaryNodeTree<ItemType> detachRightSubtree() const throw(PrecondViolatedExcep);
	...
	//------------------------------------------------------------
	BinaryNodeTree<ItemType>& operator=(const BinaryNodeTree<ItemType>&
		rightHandSide);
}; // end BinaryNodeTree
template < class ItemType>
...
template < class ItemType>
int BinaryNodeTree<ItemType>::getNumberOfNodesHelper(BinaryNode<ItemType>* subTreePtr)
const
{
	{ if (subTreePtr == nullptr)
		return 0;
...
// keep the tree balanced.
template < class ItemType>
BinaryNode<ItemType>* BinaryNodeTree<ItemType>::balancedAdd(BinaryNode<ItemType>*
...
template<class ItemType>
BinaryNode<ItemType>*
BinaryNodeTree<ItemType>::removeValue(BinaryNode<ItemType>* subTreePtr,
...
// stored in the parent.
template<class ItemType>
BinaryNode<ItemType>* BinaryNodeTree<ItemType>::moveValuesUpTree(BinaryNode<ItemType>
	* nodePtr)
{
	...
	BinaryNode<ItemType>* treePtr) const
{
	...
	{
		// Copy node
		newTreePtr = new BinaryNode<ItemType>(treePtr->getItem(), nullptr,
			nullptr);
...
// Recursive traversal helper methods:
template < class ItemType>
void BinaryNodeTree<ItemType>::preorder(void visit(ItemType&), BinaryNode<ItemType>*
	treePtr) const
{
	if (treePtr != nullptr)
	{
...
template < class ItemType>
void BinaryNodeTree<ItemType>::inorder(void visit(ItemType&), BinaryNode<ItemType>*
	treePtr) const
{
	if (treePtr != nullptr)
	{
...
template < class ItemType>
void BinaryNodeTree<ItemType>::postorder(void visit(ItemType&), BinaryNode<ItemType>*
	treePtr) const
{
	if (treePtr != nullptr)
	{
...
template < class ItemType>
BinaryNodeTree<ItemType>::BinaryNodeTree(const ItemType& rootItem, const
	BinaryNodeTree<ItemType>* leftTreePtr, const BinaryNodeTree<ItemType>* rightTreePtr)
{
...
template < class ItemType>
ItemType BinaryNodeTree<ItemType>::getRootData() const throw
...
template < class ItemType>
ItemType BinaryNodeTree<ItemType>::getEntry(const ItemType& anEntry) const throw
(PrecondViolatedExcep)
{
...
template < class ItemType>
BinaryNode<ItemType>* BinaryNodeTree<ItemType>::find(BinaryNode<ItemType>* aTree,
	const ItemType& findItem, bool& success) const {
...
//Funciona se corrigio
template < class ItemType>
void BinaryNodeTree<ItemType>::attachLeftSubtree(BinaryNodeTree<ItemType>*
	leftTreePtr) const throw(PrecondViolatedExcep)
{
	if (isEmpty())
		throw PrecondViolatedExcep("TreeException: Empty tree");
	else {
		if (rootPtr->getLeftChildPtr() != nullptr)
			throw PrecondViolatedExcep("TreeException: Can not overwrite left subtree");
		else {
...
//Funciona se corrigio
template < class ItemType>
void BinaryNodeTree<ItemType>::attachRightSubtree(BinaryNodeTree<ItemType>*
	rightTreePtr) const throw(PrecondViolatedExcep)
{
	if (isEmpty())
		throw PrecondViolatedExcep("TreeException: Empty tree");
	else {
